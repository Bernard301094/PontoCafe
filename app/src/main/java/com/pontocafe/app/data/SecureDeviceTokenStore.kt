...
class SecureDeviceTokenStore(context: Context) {
    private val prefs = context.getSharedPreferences("pontocafe_secure", Context.MODE_PRIVATE)
    ...
    fun save(token: String) {
        ...
        prefs.edit().putString(tokenKey, payload).apply()
    ...
    fun read(): String? {
        ...
        val decrypted = runCatching {
            ...
            if (bytes.size <= 12) error("Token cifrado inválido.")
